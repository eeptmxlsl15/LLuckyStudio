...
public class MouseBERSERKBOSSButton : MonoBehaviour
{
	...
	private void Awake()
	{
		berserkBossButton = GameObject.Find("MouseBERSERKBOSSButton");
	...
	private void ActivateBERSERKBOSSButton(BerserkSystemManager.ZodiacSign zodiacSign)
	{
		switch (zodiacSign)
		{
			case BerserkSystemManager.ZodiacSign.MOUSE:
				...
				Debug.Log("MouseBERSERKBOSSButton activated.");
				break;
			default:
				berserkBossButton.SetActive(false);
				Debug.Log("MouseBERSERKBOSSButton deactivated.");
				break;
		}
	}
}
