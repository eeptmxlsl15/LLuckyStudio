...
public class CowBERSERKBOSSButton : MonoBehaviour
{
	...
	private void Awake()
	{
		berserkBossButton = GameObject.Find("CowBERSERKBOSSButton");
	...
	private void ActivateBERSERKBOSSButton(BerserkSystemManager.ZodiacSign zodiacSign)
	{
		switch (zodiacSign)
		{
			case BerserkSystemManager.ZodiacSign.COW:
				...
				Debug.Log("CowBERSERKBOSSButton activated.");
				break;
			default:
				berserkBossButton.SetActive(false);
				Debug.Log("CowBERSERKBOSSButton deactivated.");
				break;
		}
	}
}
